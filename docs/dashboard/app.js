...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ==========================================
  // 5. HEADER NAV ACTIVE STATE & SCROLL SPY
  // ==========================================
  ...
  const spySections = [
    ...
    document.getElementById("methodology-section")
  ];

  // Click handler to manually toggle active state when clicked
  ...
  // Scroll spy handler to toggle active state as the user scrolls
  window.addEventListener("scroll", () => {
    ...
    spySections.forEach(section => {
      if (section) {
        const offset = section.offsetTop - 120; // 120px offset for the sticky header height
